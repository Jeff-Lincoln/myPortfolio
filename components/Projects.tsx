    ...
    <div className='h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center'>
      ...
      <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80'>
        {projects?.map((project, i) => (
          <div
            key={project?._id}
            className='w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-12 md:p-20 h-screen'
          >
            <motion.img
              initial={{
                y: -200,
              ...
              alt={project?.title}
              className='rounded-md shadow-md max-h-[400px] w-auto'
            />

            <div className='space-y-6 px-4 md:px-10 max-w-3xl text-center'>
              <h4 className='text-3xl font-semibold'>
                <span className='underline text-[#F7AB0A]'>
